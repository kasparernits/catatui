...
export { vstack, type VStackNode } from "./layout/vstack";
export { hstack, type HStackNode } from "./layout/hstack";
export { zstack, type ZStackNode } from "./layout/zstack";
...
export interface Widget {
  render(area: Rect, ctx: RenderCtx): void;
}
